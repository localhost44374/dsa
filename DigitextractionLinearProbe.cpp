...
{
    // Hash Function
    int digit1 = (key / 1000) % 10;          // Extract 1st digit - Thousands place
    int digit3 = (key / 10) % 10;            // Extract 3rd digit - Tens place
    int addr = (digit1 * 10 + digit3) % MAX; // Digit Extraction Hash Function
    int oaddr = addr;
...
int main()
{
    ...
    {
        system("cls");
        cout << "*** Hashing with Digit Extraction & Linear Probe ***\n\n";
